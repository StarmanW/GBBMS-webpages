        ...
        <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
            ...
            <div class="menu-logo">
                <div class="navbar-brand">
                    ...
                    <span class="navbar-caption-wrap">
                        <a class="navbar-caption text-white display-4" href="https://mobirise.com">Gleneagles Kota Kinabalu</a>
                    </span>
                </div>
            </div>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    <li class="nav-item">
                        <a class="nav-link link text-white display-4" href="registerDonor.html">

                            REGISTER NEW DONOR</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link link text-white display-4" href="login.html">SIGN IN</a>
                    </li>
                </ul>
            </div>
        </nav>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <input type="password" name="passwordConfirm" id="passwordConfirm" class="form-control" required="required">
                                                </div>
                                            </div>

...
<body>
                ...
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    <li class="nav-item dropdown open">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="text-white dropdown-item display-4" href="">View Lists
                                <!-- TEMP LINK -->
                                <br>
                            </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link link text-white display-4" href="login.html">
                            <!-- TEMP LINK -->
                            <span class="mbri-lock mbr-iconfont mbr-iconfont-btn"></span>LOGOUT</a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="w3-container">
        <section class="section-table cid-qMsKT09Rch" id="table1-1q">
            ...
            <div class="container align-center">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="well dash-box">
                                    <div id="turnUpChartContainer" style="height: 370px; width: 100%;"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="well dash-box">
                                    <div id="resvChartContainer2" style="height: 370px; width: 100%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div id="bloodBarChartContainer" style="height: 370px; width: 100%;"></div>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script>
        window.onload = renderBloodBarGraph();
        window.onload = renderTurnUpChart();
        window.onload = renderReservationChart();
        //window.onload = renderBarGraph(bloodDetails);        //TODO - To be uncommented later after having real data from DB

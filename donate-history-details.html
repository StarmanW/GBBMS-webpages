...
<body>
    <section class="menu cid-qMsJf9csN8" once="menu" id="menu1-1c">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    <li class="nav-item dropdown open">
                        <a class="nav-link link text-white dropdown-toggle display-4" data-toggle="dropdown-submenu" aria-expanded="true">Samuel Wong Kim Foong</a>
                                ...
                                <table class="table profile-table">
                                    <tbody>
										...
										<tr>
                                            ...
                                            <td class="body-item mbr-fonts-style display-7">450 mL</td>
                                        </tr>
										<tr>
                                            <th class="body-item mbr-fonts-style display-7">Additional Remarks</th>
                                            <td class="body-item mbr-fonts-style display-7">If you continue to feel drowsy after 3 day's time, please consult a medical professional immediately.</td>
                                        </tr>

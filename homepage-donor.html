...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/gleneagles-singapore-thumb-img-1-262x262.png" type="image/x-icon">
...
<body>
    <section class="menu cid-qMsMqKrpYp" once="menu" id="menu1-24">
                ...
                <div class="navbar-brand">
                    <span class="navbar-logo">
                        <a href="https://mobirise.com">
                            <img src="assets/images/gleneagles-singapore-thumb-img-1-262x262.png" alt="Mobirise" title="" style="height: 3.8rem;">
                        </a>
                    </span>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    <li class="nav-item dropdown open">
                        <a class="nav-link link text-white dropdown-toggle display-4" data-toggle="dropdown-submenu" aria-expanded="true">Enjiun Tan</a>
    ...
    <section class="features13 cid-qMsMqKYHaC" id="features13-25">
        ...
        <div class="container">
            <h2 class="mbr-section-title pb-3 mbr-fonts-style display-1">Welcome, Enjiun</h2>
            <div class="media-container-row container">
                ...
                <!-- TEMP LINK -->
                <div class="card col-12 col-md-6 p-5 m-3 align-center col-lg-4 card-text hover-image" onclick="window.location='./donor-profile.html';">
                    <div class="card-img">
            ...
            <div class="media-container-row content text-white">
                <div class="col-12 col-md-3">
                    <div class="media-wrap">
                        <a href="https://mobirise.com/">
                            <img src="assets/images/gLogo.png" alt="Mobirise" title="">
                        </a>
                    </div>
                </div>
